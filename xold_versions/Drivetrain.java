...
package com.team3176.robot.subsystems.drivetrain;
...
public class Drivetrain extends SubsystemBase {
  ...
  private final Swervepod[] modules = new Swervepod[4]; // FL, FR, BL, BR
  ...
  public Drivetrain(
      GyroIO gyroIO,
      SwervepodIO flModuleIO,
      SwervepodIO frModuleIO,
      SwervepodIO blModuleIO,
      SwervepodIO brModuleIO) {
    this.gyroIO = gyroIO;
    modules[0] = new Swervepod(flModuleIO, 0, TunerConstants.FrontLeft);
    modules[1] = new Swervepod(frModuleIO, 1, TunerConstants.FrontRight);
    modules[2] = new Swervepod(blModuleIO, 2, TunerConstants.BackLeft);
    modules[3] = new Swervepod(brModuleIO, 3, TunerConstants.BackRight);
  ...
  public void periodic() {
    ...
    // Update gyro alert
    gyroDisconnectedAlert.set(!gyroInputs.connected && BaseConstants.getMode() != Mode.SIM);
  }
