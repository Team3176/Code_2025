...
public class SuperStructureConstants {
  ...
  public static final double CLIMB_MAXRETRACT_POS = 20; // CLIMB_ZERO_POS - 20;
  public static final double CLIMB_DEPLOY_POS = 160 + CLIMB_ZERO_POS;
  public static final double CLIMB_MAXDEPLOY_POS = -143 + CLIMB_ZERO_POS;
  ...
  public static final double ARM_HF_VOLTS = 2;
  ...
  public static final double ELEVATORLEADER_TOP_POS = 95 + ELEVATORLEADER_ZERO_POS;
  ...
  public static final double ELEVATORLEADER_L4_POS = 90 + ELEVATORLEADER_ZERO_POS;
