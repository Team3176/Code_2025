...
package com.team3176.robot.subsystems.controller;

import edu.wpi.first.wpilibj2.command.button.CommandJoystick;
import edu.wpi.first.wpilibj2.command.button.CommandXboxController;
import com.team3176.robot.constants.ControllerConstants;
...
public class Controller {
  ...
  public Controller() {
    ...
    switchBox = new CommandJoystick(ControllerConstants.SWITCH_ID);
  }
