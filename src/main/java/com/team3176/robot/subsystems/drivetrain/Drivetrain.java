...
import com.team3176.robot.constants.SwervePodHardwareID;
import com.team3176.robot.util.AllianceFlipUtil;
...
import com.team3176.robot.util.swerve.ModuleLimits;
import com.team3176.robot.util.swerve.SwerveSetpoint;
import com.team3176.robot.util.swerve.SwerveSetpointGenerator;
...
public class Drivetrain extends SubsystemBase {
  ...
  private Drivetrain(GyroIO io) {
    ...
    AutoBuilder.configure(
        ...
        (speeds, feedforward) -> this.driveVelocityAuto(speeds),
