...
public class IndexerIOTalon implements IndexerIO {
  ...
  public IndexerIOTalon() {
    ...
    // rollerLinebreak = new DigitalInput(Hardwaremap.IndexerRollerLinebreak_DIO);
    // pivotLinebreak = new DigitalInput(Hardwaremap.IndexerPivotLinebreak_DIO);

    upperLimitSwitch = new DigitalInput(Hardwaremap.indexerUpperLimitSwitch_DIO);
    lowerLimitSwitch = new DigitalInput(Hardwaremap.indexerLowerLimitSwitch_DIO);

    rollerController = new TalonFX(Hardwaremap.indexerRoller_CID, Hardwaremap.indexerRoller_CBN);
    pivotController = new TalonFX(Hardwaremap.indexerPivot_CID, Hardwaremap.indexerPivot_CBN);
